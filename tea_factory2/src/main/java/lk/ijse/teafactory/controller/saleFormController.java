...
public class saleFormController {
    ...
    @FXML
    private TableColumn<?, ?> colSaleStatus;
    ...
    @FXML
    private TextField txtSaleStatus;
    ...
    void btnSaveOnAction(ActionEvent event) {
        ...
        Date sale_date = Date.valueOf(txtSaleDate.getText());
        String sale_status = txtSaleStatus.getText();
        ...
        try {
            ...
            pstm.setObject(2, sale_date);
            pstm.setObject(3, sale_status);
